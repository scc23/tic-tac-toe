...
def updateGUI(thisBoard, mode):
    ...
    if thisBoard[1] == " ":
        button1 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard_AI(1, mode))
        button1.grid(row=3, column=1)
    if thisBoard[2] == " ":
        button2 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard_AI(2, mode))
        button2.grid(row=3, column=2)
    if thisBoard[3] == " ":
        button3 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard_AI(3, mode))
        button3.grid(row=3, column=3)
    if thisBoard[4] == " ":
        button4 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard_AI(4, mode))
        button4.grid(row=2, column=1)
    if thisBoard[5] == " ":
        button5 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard_AI(5, mode))
        button5.grid(row=2, column=2)
    if thisBoard[6] == " ":
        button6 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard_AI(6, mode))
        button6.grid(row=2, column=3)
    if thisBoard[7] == " ":
        button7 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard_AI(7, mode))
        button7.grid(row=1, column=1)
    if thisBoard[8] == " ":
        button8 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard_AI(8, mode))
        button8.grid(row=1, column=2)
    if thisBoard[9] == " ":
        button9 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard_AI(9, mode))
        button9.grid(row=1, column=3)

    # check for "X"
    if thisBoard[1] == "X":
        button1 = Button(root, text="X", state=DISABLED, width=3, height=2, font=customFont)
        button1.grid(row=3, column=1)
    if thisBoard[2] == "X":
        button2 = Button(root, text="X", state=DISABLED, width=3, height=2, font=customFont)
        button2.grid(row=3, column=2)
    if thisBoard[3] == "X":
        button3 = Button(root, text="X", state=DISABLED, width=3, height=2, font=customFont)
        button3.grid(row=3, column=3)
    if thisBoard[4] == "X":
        button4 = Button(root, text="X", state=DISABLED, width=3, height=2, font=customFont)
        button4.grid(row=2, column=1)
    if thisBoard[5] == "X":
        button5 = Button(root, text="X", state=DISABLED, width=3, height=2, font=customFont)
        button5.grid(row=2, column=2)
    if thisBoard[6] == "X":
        button6 = Button(root, text="X", state=DISABLED, width=3, height=2, font=customFont)
        button6.grid(row=2, column=3)
    if thisBoard[7] == "X":
        button7 = Button(root, text="X", state=DISABLED, width=3, height=2, font=customFont)
        button7.grid(row=1, column=1)
    if thisBoard[8] == "X":
        button8 = Button(root, text="X", state=DISABLED, width=3, height=2, font=customFont)
        button8.grid(row=1, column=2)
    if thisBoard[9] == "X":
        button9 = Button(root, text="X", state=DISABLED, width=3, height=2, font=customFont)
        button9.grid(row=1, column=3)

    # check for "O"
    if thisBoard[1] == "O":
        button1 = Button(root, text="O", state=DISABLED, width=3, height=2, font=customFont)
        button1.grid(row=3, column=1)
    if thisBoard[2] == "O":
        button2 = Button(root, text="O", state=DISABLED, width=3, height=2, font=customFont)
        button2.grid(row=3, column=2)
    if thisBoard[3] == "O":
        button3 = Button(root, text="O", state=DISABLED, width=3, height=2, font=customFont)
        button3.grid(row=3, column=3)
    if thisBoard[4] == "O":
        button4 = Button(root, text="O", state=DISABLED, width=3, height=2, font=customFont)
        button4.grid(row=2, column=1)
    if thisBoard[5] == "O":
        button5 = Button(root, text="O", state=DISABLED, width=3, height=2, font=customFont)
        button5.grid(row=2, column=2)
    if thisBoard[6] == "O":
        button6 = Button(root, text="O", state=DISABLED, width=3, height=2, font=customFont)
        button6.grid(row=2, column=3)
    if thisBoard[7] == "O":
        button7 = Button(root, text="O", state=DISABLED, width=3, height=2, font=customFont)
        button7.grid(row=1, column=1)
    if thisBoard[8] == "O":
        button8 = Button(root, text="O", state=DISABLED, width=3, height=2, font=customFont)
        button8.grid(row=1, column=2)
    if thisBoard[9] == "O":
        button9 = Button(root, text="O", state=DISABLED, width=3, height=2, font=customFont)
        button9.grid(row=1, column=3)
...
img = Image.open("/Users/shermanchow/Documents/git/tic-tac-toe/mac/tictactoe_bg.png")
tkImage = ImageTk.PhotoImage(img)
background = Label(root, image=tkImage)
...
def updateGUIBoard(pos):
    ...
    updateButton = Button(root, text=mark, state=DISABLED, width=3, height=2, font=customFont)
    if pos == 1:
...
def startPlayerGame():
    ...
    # setup game board
    if board[1] == " ":
        button1 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard(1))
        button1.grid(row=3, column=1)
    if board[2] == " ":
        button2 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard(2))
        button2.grid(row=3, column=2)
    if board[3] == " ":
        button3 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard(3))
        button3.grid(row=3, column=3)
    if board[4] == " ":
        button4 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard(4))
        button4.grid(row=2, column=1)
    if board[5] == " ":
        button5 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard(5))
        button5.grid(row=2, column=2)
    if board[6] == " ":
        button6 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard(6))
        button6.grid(row=2, column=3)
    if board[7] == " ":
        button7 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard(7))
        button7.grid(row=1, column=1)
    if board[8] == " ":
        button8 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard(8))
        button8.grid(row=1, column=2)
    if board[9] == " ":
        button9 = Button(root, text=" ", width=10, height=6, command=lambda:updateGUIBoard(9))
        button9.grid(row=1, column=3)
...
def selectDifficulty():
    ...
    # difficultyText = Label(root, text="Difficulty", font=menuFont)
    easyButton = Button(root, text="Easy Mode", width=16, height=4, font=menuFont, command=lambda:startAIGame(1))
    normalButton = Button(root, text="Normal Mode", width=16, height=4, font=menuFont, command=lambda:startAIGame(3))
    hardButton = Button(root, text="Hard Mode", width=16, height=4, font=menuFont, command=lambda:startAIGame(2))

    # difficultyText.grid(row=0, column=1)
...
# GUI menu
customFont = tkFont.Font(family="Helvetica", size=47)
menuFont = tkFont.Font(family="Helvetica", size=20)

# display the game menu
# menuText = Label(root, text="Main Menu", font=menuFont)
# menuText.grid(row=0, column=1)
buttonPlayer = Button(root, text="Player vs Player", width=16, height=4, font=menuFont, command=lambda:startPlayerGame())
# buttonAI = Button(root, text="Player vs AI", width=15, height=3, font=menuFont, command=lambda:startAIGame())
buttonAI = Button(root, text="Player vs AI", width=16, height=4, font=menuFont, command=lambda:selectDifficulty())
